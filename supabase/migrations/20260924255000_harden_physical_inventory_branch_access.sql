-- ============================================================
-- LULA OS
-- SEGURIDAD FINAL — INVENTARIO FÍSICO
-- ============================================================
--
-- Corrige el acceso por sucursal de:
--   start_inventory_count
--   set_inventory_count_item
--   complete_inventory_count
--
-- IMPORTANTE:
-- shared_inventory CONTINÚA SIENDO GLOBAL.
-- No se divide inventario por sucursal.
--
-- La sucursal solamente determina quién puede iniciar,
-- capturar y cerrar el conteo físico.
-- ============================================================
...
BEGIN
  ...
  -- SEGURIDAD:
  -- el usuario debe tener acceso real a la sucursal.
  ...
  -- Solo un inventario físico activo
  ...
  --
  -- shared_inventory continúa siendo
  -- la única existencia del negocio.
...
BEGIN
  ...
  -- Obtener el conteo y su sucursal.
  ...
  -- del conteo, no solamente ser manager.
...
BEGIN
  ...
  -- SEGURIDAD:
  -- validar acceso a la sucursal del conteo.
  ...
  -- ==========================================================
  -- APLICAR DIFERENCIAS SOBRE SHARED_INVENTORY
  -- ==========================================================
  ...
  LOOP
    ...
    -- se crea con la existencia física.
    ...
    ELSE
      ...
      -- El conteo físico se convierte
      -- en la existencia central definitiva.
...
IS
'LULA OS: inicia inventario físico central y valida acceso a la sucursal.';

COMMENT ON FUNCTION public.set_inventory_count_item(uuid, uuid, numeric)
IS
'LULA OS: captura conteo físico validando acceso a la sucursal del conteo.';

COMMENT ON FUNCTION public.complete_inventory_count(uuid)
IS
'LULA OS: cierra inventario físico central validando acceso a la sucursal.';
